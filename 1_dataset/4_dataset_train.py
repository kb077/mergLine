...
train_list=[]
test_list=[]
with h5py.File(train_dataset_h5,'w') as hf:
    for dir_tmp in [dir2,dir3,dir4,dir5,dir6,dir7,dir8,dir9,dir10]:
        c=0
...
print(f'Data has been successfully stored in {train_dataset_h5}.')
